...
import Utillities.PropertyFileUtil;
...
//method for waitfor element
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Throwable
	{
		...
		FileWriter fr=new FileWriter("D:\\mrng930batch\\ERP_Stock\\CaptureData");
	...
	if(driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-box"))).isDisplayed())
	 ...
	 {
		 String Act_data = driver.findElement(By.xpath("//table[@id='tbl_a_supplierslist']/tbody/tr["+i+"]/td["+column1+"]/div/span")).getText();		
	   Thread.sleep(4000);
	...
	public static void tableValidation1(WebDriver driver,String Exp_data) throws Throwable
	{
		...
		{
			driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("Click-searchpanell"))).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-box1"))).clear();
			Thread.sleep(3000);
			driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-box1"))).sendKeys(Exp_data);
		...
		for(int i=1;i<rows.size();i++)
		{
			...
			String  Act_Data=driver.findElement(By.xpath("//table[@id='tbl_a_stock_categorieslist']/tbody/tr[2]/td[4]/div/span/span")).getText();
